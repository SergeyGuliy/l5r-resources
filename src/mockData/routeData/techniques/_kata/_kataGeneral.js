...
<p><strong>Пустота YY:</strong> Вы называете два кольца, затем ваш противник должен назвать одно из этих двух колец. Когда ваш противник выбирает свою стойку во время первого хода дуэли, он не может выбрать кольцо, которое он назвал своей стойкой.&nbsp;</p>
...
<p><strong>Активация:</strong> Когда вы совершаете проверку Боевых искусств [Ближний бой, Стрельба или Безоружный бой] (Воздух), вы можете потратить Y следующим образом:</p>
<p><strong style="color: #754e40;">Возможности Техники</strong></p>
<p><strong>Воздух Y+:</strong> Зарезервируйте одну из ваших брошенных костей, плюс одну дополнительную кость за YY, потраченные таким образом. 
Эти кости становятся удалёнными костями. 
Совершая проверку с тем же навыком до конца вашего следующего хода, вы можете бросить на одну меньше Z за каждую зарезервированную Z и на одну меньше X за каждую зарезервированную X, а затем добавить зарезервированные кости к своему броску. Эти кости считаются брошенными, но добавляют результат, который был у них при резервировании.</p>        
`,
