...
<p><strong style="color: #754e40;">Возможности Техники</strong></p>
<p><strong>Воздух YY+:</strong> Во время полета, вы можете нести с собой до одного дополнительного готового к этому персонажа на дистанции 0&ndash;2 за каждые YY, потраченные таким образом.</p>
    `,
  },
...
<p><strong>Воздух YY+:</strong> Выберите одного дополнительного персонажа на дистанции 0-1 за каждые YY потраченные таким образом. Выбранные персонажи также могут видеть скрытые объекты.</p>
    `,
  },
  Plash_nochi: {
    title: "Плащ ночи",
...
<p><strong style="color: #754e40;">Возможности Техники</strong></p>
<p><strong>Воздух YY+:</strong> Выберите одну дополнительную цель той же фигуры или меньше за каждые YY, потраченные таким образом.</p>
    `,
  },
...
<p><strong>Воздух YY+:</strong> Этот эффект сохраняется в течение одной дополнительной сцены за каждые YY, потраченные таким образом.</p>
    `,
  },
...
<p><strong>Воздух YY+:</strong> Эффект сохраняется в течение двадцати четырех дополнительных часов за каждые YY, потраченные таким образом.</p>
    `,
  },
  Vosstan_Vozduh: {
...
<p style="text-align: left;"><strong>Воздух YY:</strong> Туман превращается в ледяную бурю, из-за чего он также становится Опасной местностью.</p>
    `,
  },
  Burya_Vozduha: {
    title: "Буря Воздуха",
...
<p><strong>Воздух YY:</strong> Иллюзорные объекты, которые вы вызываете таким образом, имеют массу, и их можно использовать так, как если бы они были реальными (хотя они все еще неодушевленные и поэтому не двигаются сами по себе). Они по-прежнему исчезают, когда эффект заканчивается.</p>
    `,
  },
  Gnev_Kaze_no_Kami: {
...
<p><strong>Воздух YY:</strong> Находясь внутри урагана, вы можете летать, двигаться вертикально и игнорировать влияние местности.</p>
    `,
  },
  Yari_Vozduha: {
    title: "Яри Воздуха",
...
<p><strong>Воздух YY:</strong> Вы можете призвать пару видов оружия вместо одного.</p>
    `,
  },
};
...
export const _appealAir = injector(obj, (original) => ({
  ...
  description: addAppealOpportunities(original.description, "air"),
}));
