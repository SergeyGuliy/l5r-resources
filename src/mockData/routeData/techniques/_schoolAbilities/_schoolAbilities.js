...
`,
  ...
  MasterBuilder: {
    ...
    description: `
<p>один
раз за сцену, когда вы делаете проверку на использование предмета, созданного вами лично, вы можете добавить со значением Y к оставленным
...
пробуждения объекта, вы можете добавить со
...
добавить со значением Y к оставленным костям
...
этого поменять на оставленных костях значение
